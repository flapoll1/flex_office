...
export const WORKSTATIONSMOCK: Workstation[] = [
  ...
  {id: 6, label: '3.14/3', telephone: false, mouse: false, headset: false, noise: 1, freeDays: ['2019-10-11', '2019-10-13']},
  {id: 7, label: '3.14/4', telephone: true, mouse: false, headset: true, noise: 1, freeDays: ['2019-10-14', '2019-10-15']},
  {id: 8, label: '3.13/1', telephone: false, mouse: false, headset: true, noise: 1, freeDays: ['2019-10-11', '2019-10-17']},
  {id: 9, label: '3.13/2', telephone: true, mouse: true, headset: false, noise: 2, freeDays: ['2019-10-01', '2019-10-15']},
  {id: 10, label: '3.13/3', telephone: true, mouse: false, headset: false, noise: 2, freeDays: ['2019-10-12', '2019-10-30']},
  {id: 11, label: '3.13/4', telephone: false, mouse: false, headset: true, noise: 2, freeDays: ['2019-10-13', '2019-10-31']},
  ...
  {id: 17, label: '3.11/3', telephone: true, mouse: false, headset: true, noise: 2, freeDays: ['2019-10-10', '2019-10-11']}
];
